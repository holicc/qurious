...
use crate::logical::plan::{CrossJoin, Filter, Join, LogicalPlan, SubqueryAlias};
use crate::logical::LogicalPlanBuilder;
use crate::optimizer::rule::rule_optimizer::OptimizerRule;
use crate::utils::expr::{conjunction, replace_col, replace_cols, replace_cols_by_name, split_conjunctive_predicates};
...
mod tests {
    use crate::{
        optimizer::rule::{pushdown_filter_join::PushdownFilter, ExtractEquijoinPredicate},
